...
training_bird <- aac_intakes_outcomes_bird[ train_function,]
testing_bird  <- aac_intakes_outcomes_bird[-train_function,]
```
...
predictions_tree <- predict(tree_cv5, testing_bird)
confus.res_tree <- confusionMatrix(predictions_tree, testing_bird$outcome_type)
confus.res_tree
```
