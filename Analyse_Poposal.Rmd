...
```{r check recodings, include=FALSE}
...
```{r check recoding, include=FALSE, message=FALSE, warning=FALSE}
...
```{r}
importance <- varImp(tree_rabbit1)
print(importance)
plot(importance, top=20)
```
