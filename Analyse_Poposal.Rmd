...
training_dog_subsmample = training_dog[vars]
...
testing_dog_subsmample = testing_dog[vars]

pred_tree_dog <- predict(tree_dog, testing_dog[vars])
conf_matrix_tree_dog <- confusionMatrix(pred_tree_dog, testing_dog[vars]$outcome_type)
