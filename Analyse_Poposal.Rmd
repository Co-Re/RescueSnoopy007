...
* `sex_upon_intake` - Diese Variable enthält die selben Daten wie `sex_upon_outcome`, ist daher redundant.
...
Die Accuracy des NNs für Hasen ist unter Berücksichtigung aller Variablen ist etwas besser als unter Verwendung eines Subsets. Die Accuracy des Treemodels kann, wie auch bei den Katzen, mit dem Neuronalen Netz nicht mehr verbessert werden. 
